  ...
  return (
    <div className="home container">
      ...
      >
        ...
        >
          <span>🚀</span> {courses.length}章精品课程 · 三大阶段系统学习
        </motion.div>

        <h1 className="hero-title">C++ 系统学习课程</h1>

        <p className="hero-subtitle">
          从基础语法到数据结构，再到进阶算法，系统掌握 C++ 编程与信息学竞赛技巧
        </p>
      ...
      >
        ...
        <div className="parts-grid">
          {parts.map((part) => {
            const partCourses = getPartCourses(part.id)
            const categories = [...new Set(partCourses.map(c => c.category))]
      ...
      >
        ...
        <div>Made with ❤️ for competitive programming</div>
      </motion.footer>
    </div>
  )
}
